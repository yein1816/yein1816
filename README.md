...
### 🎁 GoodsPle — 팬덤 굿즈 교환 & 거래 플랫폼 (사이드 프로젝트,진행중)
- 팬덤 굿즈의 교환 및 거래를 위한 웹서비스로, 후기 시스템과 실시간 채팅 기능을 중심으로 사용자 신뢰도 확보를 목표로 함
- 프론트엔드와 백엔드를 함께 맡아 풀스택으로 기여

담당 기능:
- 백엔드: 로그인, 회원가입, 회원정보 수정, 게시글 관련 후기 등록/수정/삭제, 신고 기능 구현
- 프론트엔드 화면: 공통 헤더/푸터, 로그인, 회원가입, 아이디/비밀번호 찾기, 카카오 추가정보 입력, 회원정보 수정, 후기 등록/리스트 화면(내가 작성한 후기/받은 후기), 에러 페이지
