## 👋 안녕하세요, 풀스택 개발자 꿈꾸며 성장 중인 정예인입니다.
...
**프론트엔드 개발자 (2025.11 ~ 재직중)** 
📍 (주)선유기술 (공공앱 안심이 앱 외 다수 프로젝트 유지보수)

- 안심이 앱 메인화면 UI 리뉴얼
- 안심이 앱 챗봇 신규 서비스 개발
- 안심이 앱 앱접근성 메인 주도
- 강남,송파구청 도로점용허가시스템 유지보수 
---
...
### 🎁 GoodsPle — 팬덤 굿즈 교환 & 거래 플랫폼 (사이드 프로젝트)
- 팬덤 굿즈의 교환 및 거래를 위한 웹서비스로, 후기 시스템과 실시간 채팅 기능을 중심으로 사용자 신뢰도 확보를 목표로 함
- 프론트엔드와 백엔드를 함께 맡아 풀스택으로 기여

담당 기능:
- 백엔드: 로그인, 회원가입, 회원정보 수정, 게시글 관련 후기 등록/수정/삭제, 신고 기능, 채팅 방 생성 및 채팅 송수신, 읽음처리 구현
- 프론트엔드 화면: 공통 헤더/푸터, 로그인, 회원가입, 아이디/비밀번호 찾기, 카카오 추가정보 입력, 회원정보 수정, 메인화면, 후기 등록/리스트 화면(내가 작성한 후기/받은 후기), 에러 페이지

- 주요 기술: React, TypeScript, Spring Boot, MyBatis, PostgreSQL, Kakao Login
